                ...
                <div class="row margin-b-0">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="tag-about green lb-sm">
                                                    {{count(App\Topup::where('created_by','=',$uid)->where('date','=',$current)->get())}}
                                                </span>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <span class="tag-about green lb-sm">
                                                    {{count(App\Topup::where('created_by','=',$uid)->where('card','=',1)->where('date','=',$current)->get())}}
                                                </span>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <span class="tag-about green lb-sm">
                                                    {{count(App\Topup::where('created_by','=',$uid)->where('card','=',2)->where('date','=',$current)->get())}}
                                                </span>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <span class="tag-about green lb-sm">
                                                    {{count(App\Topup::where('created_by','=',$uid)->where('card','=',3)->where('date','=',$current)->get())}}
                                                </span>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <span class="tag-about green lb-sm">
                                                    {{count(App\Topup::where('created_by','=',$uid)->where('card','=',4)->where('date','=',$current)->get())}}
                                                </span>
                                            </td>
                                        </tr>
                                    </tbody>
                    ...
                    <div class="col s12 m12 l12">
                        <div class="card">
                            ...
                            <?php 
                                $id = $user->id; 
                                $topups = App\Topup::where('created_by','=',$id)->get();
                            ?>
                            <tbody>
