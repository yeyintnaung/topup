    ...
    <div class="page-content">
        ...
        <div class="row margin-b-0">
            <div class="col s12 m6 l3">
                <div class="card">
                    <div class="card-content">  
                        <span class="card-title about-tag teal type">MPT 1,000 Ks</span>
                                
                        <div class="row margin-b-0">
                            <form class="col s12" action="{{asset('mpttopup')}}" method="POST">
                                <div class="row">
            ...
            <div class="col s12 m6 l3">
                <div class="card">
                    <div class="card-content">  
                        <span class="card-title about-tag teal type">MPT 3,000 Ks</span>
                        <div class="row margin-b-0">
                            <form class="col s12" action="{{asset('mpttopup')}}" method="POST">
                                <div class="row">
                                    <div class="input-field col s12">
            ...
            <div class="col s12 m6 l3">
                <div class="card">
                    <div class="card-content">  
                        <span class="card-title about-tag teal type">MPT 5,000 Ks</span>
                        <div class="row margin-b-0">
                            <form class="col s12" action="{{asset('mpttopup')}}" method="POST">
                                <div class="row">
                                    <div class="input-field col s12">
            ...
            <div class="col s12 m6 l3">
                <div class="card">
                    <div class="card-content">  
                        <span class="card-title about-tag teal type">MPT 10,000 Ks</span>
                        <div class="row margin-b-0">
                            <form class="col s12" action="{{asset('mpttopup')}}" method="POST">
                                <div class="row">
                                    <div class="input-field col s12">
