    ...
    <div class="page-content">
                ...
                <div class="card no-shadow">
                    <div class="card-content">  
                        <span class="card-title">Topup Status
                            ...
                            <span class="tag-about blue">6,000 Ks - 
                                <?php $_6000 = App\Topup::where('date','=',date('Y-m-d'))
                                ->where('card','=',4)
                                ->where('created_by','=',$user)
                                ->where('amount','=',6000)
                                ->get();?>
        ...
        <div class="row margin-b-0">
            <div class="col s12 m6 l3">
                <div class="card">
                    <div class="card-content">  
                        <span class="card-title about-tag teal type">Telenor Magic 6,000 Ks</span>
                                
                        <div class="row margin-b-0">
                            <form class="col s12" action="{{asset('telenormagictopup')}}" method="POST">
                                <div class="row">
