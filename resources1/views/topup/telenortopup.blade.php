    ...
    <div class="page-content">
            ...
            <div class="col s12 m12 l12">
                <div class="card no-shadow">
                    <div class="card-content">  
                        <span class="card-title">Topup Status
        ...
        <div class="row margin-b-0">
            <div class="col s12 m6 l3">
                <div class="card">
                    <div class="card-content">  
                        <span class="card-title about-tag teal type">Telenor 1,000 Ks</span>
            ...
            <div class="col s12 m6 l3">
                <div class="card">
                    <div class="card-content">  
                        <span class="card-title about-tag teal type">Telenor 3,000 Ks</span>
                        <div class="row margin-b-0">
                            <form class="col s12" action="{{asset('telenortopup')}}" method="POST">
                                <div class="row">
                                    <div class="input-field col s12">
                                        <input type="number" id="" class="validate" name="code" required/>
                                        <label for="number" class="">Topup Code</label>
                                    </div>
                                    <div class="input-field col s12">
                                        <button type="submit" class="waves-effect waves-light btn indigo btn-block top-8">Create</button>
            ...
            <div class="col s12 m6 l3">
                <div class="card">
                    <div class="card-content">  
                        <span class="card-title about-tag teal type">Telenor 5,000 Ks</span>
                        <div class="row margin-b-0">
                            <form class="col s12" action="{{asset('telenortopup')}}" method="POST">
                                <div class="row">
                                    <div class="input-field col s12">
            ...
            <div class="col s12 m6 l3">
                <div class="card">
                    <div class="card-content">  
                        <span class="card-title about-tag teal type">Telenor 10,000 Ks</span>
                        <div class="row margin-b-0">
                            <form class="col s12" action="{{asset('telenortopup')}}" method="POST">
                                <div class="row">
                                    <div class="input-field col s12">
