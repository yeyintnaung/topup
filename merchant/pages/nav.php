<!-- Navigation -->
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">The Banyan | Merchant Panel</a>
            </div>
            <!-- /.navbar-header -->
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="all-topups.php">All Topups</a>
                                </li>
                                <li>
                                    <a href="all-invoices.php">All Invoices</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        ...
                        <li>
                            <a href="#">   
                                <i class="fa fa-table fa-fw"></i> Readme
                            </a>
                        </li>
                    </ul>
                </div>
