                                            ...
                                            @foreach($users as $key=>$user)
                                                <tr>
                                                    ...
                                                    <th>
                                                        ...
                                                        <a class="waves-effect waves-light tag-about indigo" href="{{asset('user/edit/'.$user->id)}}">Edit</a>
                                                        <a class="waves-effect waves-light tag-about red" href="{{asset('user/delete/'.$user->id)}}">Delete</a>
                                                    </th>
                                                </tr>
                                            @endforeach
                                            </tbody>
